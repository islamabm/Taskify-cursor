...
import { TaskType, UserType } from "../../types/commonTypes/commonTypes";
...
import { AddTaskTypeModal } from "../modals/AddTaskTypeModal";
import { EditTaskTypeModal } from "../modals/EditTaskTypeModal";
import { AddUserTypeModal } from "../modals/AddUserTypeModal";
import { EditUserTypeModal } from "../modals/EditUserTypeModal";


interface UserTypesTableProps<T> {
...
export function UserTypesTable<T>({ userTypes, columnVisibilityName, placeHolder, filterColumnName, tableTitle, columnNames, inputTableName, excelConfig }: UserTypesTableProps<T>) {
    ...
    const TableUserTypesColumns: ColumnDef<UserType>[] = [
...

        {
            ...
            cell: (info) => (
                <div className="flex items-center  gap-2">
                    {/* <EditTaskTypeModal taskTypeData={info.row.original} /> */}
                    <EditUserTypeModal userTypeData={info.row.original} />
                    <DeleteValidationModal tooltipTitle='Delete user type' alertDialogTitle='Are you sure you want to delete this user type?' whichCmp='user-type' usefulVariable={info.row.original.userTypeID} queryOptionalVariable='employeeId' />
                </div>)
        },
